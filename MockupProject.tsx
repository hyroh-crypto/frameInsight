...
import { ChevronLeft, Save, Briefcase, Plus, Search, Users, Calendar, FileText, BarChart3, CheckCircle, Package, Archive, RotateCcw } from 'lucide-react';
      ...
      <div className="p-6 overflow-y-auto flex-1">
         ...
         <div className="space-y-4">
            {sortedProjects.map((proj: any, idx: number) => (
              <div key={idx} className={`bg-white border border-gray-200 border-l-[6px] ${getDeptColor(proj.execDept)} rounded-xl p-6 hover:shadow-lg transition-all relative group`}>
